...
function Creators() {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center my-20 bg-gray-100 h-30">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-x-0 bottom-0 transform translate-y-1/2">
              <img
                ...
                alt="avatar"
                className="w-30 h-16 mt-20 rounded-full mx-auto border-4 border-gray-700"
              />
            </div>
          </div>
